...
I am an experienced **Fullstack Developer** with a strong background in building scalable, high-performance web applications. My expertise spans the entire software development lifecycle, from architectural design to deployment and optimization. I am passionate about clean code, best practices, and leveraging cutting-edge technologies to solve complex business problems.

- 🔭 I’m currently working on **Enterprise-level architectures**.
- 🎓 I studied at **Universidad Nacional de Trujillo**.
- 🌍 I'm based in **Trujillo, Peru** (UTC -05:00).
...
As a Senior Developer, I have mastered a wide variety of tools and languages. Here is an overview of my technical arsenal:
